...
import os
import sys
# basedir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "../final_project"))
...
project = '2021sp CSCI-E-20 Final Project - Covid and Vaccine Data Visualization'
copyright = '2021, Muthu Venkataraman'
author = 'Muthu Venkataraman'
