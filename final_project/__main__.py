...
from final_project.etl.tasks_vaccine_data import ByCountry, ByCountryMonth
...
if __name__ == "__main__":
    ...
    build([ByCountry(subset=False)], local_scheduler=True)
    build([ByCountryMonth(subset=False)], local_scheduler=True)
